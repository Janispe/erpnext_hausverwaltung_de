...
scheduler_events = {
	...
	"cron": {
		...
		"1 0 * * *": [
			...
			"hausverwaltung.hausverwaltung.doctype.wartungsplan.wartungsplan.update_faelligkeitsstatus",
			"hausverwaltung.hausverwaltung.doctype.anlagendokument.anlagendokument.update_gueltigkeitsstatus",
		],
