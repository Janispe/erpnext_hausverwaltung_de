...
def _ensure_serienbrief_dokument_print_format(*, reason: str) -> None:
    from mail_merge.install import _ensure_serienbrief_dokument_print_format as ensure_core_print_format

    ensure_core_print_format(reason=reason)
...
def _ensure_serienbrief_print_format_link_field(*, reason: str) -> None:
    from mail_merge.install import _ensure_serienbrief_print_format_link_field as ensure_core_link_field

    ensure_core_link_field(reason=reason)
...
_HAUSVERWALTUNG_CARD_SECTIONS: list[dict] = [
    ...
    },
    {
        ...
        "icon": "database",
        "links": [
            {"label": "Assistent", "link_type": "Page", "link_to": "hausverwaltung-assistant"},
...
def ensure_hausverwaltung_sidebar() -> None:
    ...
    try:
        ...
        add({"label": "Assistent", "type": "Link", "link_type": "Page", "link_to": "hausverwaltung-assistant", "icon": "search"})
