...
SERIENBRIEF_MARGIN_DEFAULTS: dict[str, float] = {
    ...
    # Kategorien-Pfad). Footer ist ~6mm hoch, 16mm gibt großzügig Luft.
    "margin_bottom": 16.0,
...
def _ensure_serienbrief_dokument_print_format(*, reason: str) -> None:
    ...
    try:
        ...
        footer_html = """
<div id="footer-html" style="width: 100%; padding: 1px 0 1px; border-top: 1px solid #000; font-size: 4pt; color: #000 !important; text-align: center; font-family: Arial, sans-serif; line-height: 1.05; height: 6mm; min-height: 6mm; box-sizing: border-box;">
...
{%- if bank_html -%}<div style="font-size: 4pt !important; line-height: 1.05 !important; color: #000 !important; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ bank_html | safe }}</div>{%- endif -%}
{%- if pfad_html -%}<div style="font-size: 4pt !important; line-height: 1.05 !important; color: #000 !important; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ pfad_html }}</div>{%- endif -%}
</div>
"""
