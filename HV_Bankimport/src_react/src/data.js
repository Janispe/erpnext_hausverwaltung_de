...
export const MOCK_BANKIMPORT_RULES = {
	groups: {
		party: {
			...
			counts: { total: 2, enabled: 2, disabled: 0, system: 2 },
			items: [
				{
					doctype: "Bankimport Party Regel",
					name: "system.unique_iban_to_party",
					ruleKey: "system.unique_iban_to_party",
					enabled: true,
					isSystemRule: true,
					priority: 10,
					matcherFunction: "unique_iban_to_party",
					stopOnMatch: true,
				...
				{
					doctype: "Bankimport Party Regel",
					name: "system.row_party",
					ruleKey: "system.row_party",
					enabled: true,
					isSystemRule: true,
					priority: 100,
					matcherFunction: "row_party",
					stopOnMatch: true,
					requiresReview: false,
		...
		booking: {
			...
			counts: { total: 4, enabled: 4, disabled: 0, system: 4 },
			items: [
				{
					doctype: "Bankimport Buchungsregel",
					name: "system.invoice_auto_match",
					ruleKey: "system.invoice_auto_match",
					enabled: true,
					isSystemRule: true,
					priority: 100,
					matcherFunction: "invoice_auto_match",
					autoApply: true,
					stopOnMatch: true,
					requiresReview: false,
				...
				{
					doctype: "Bankimport Buchungsregel",
					name: "system.kreditrate_auto_match",
					ruleKey: "system.kreditrate_auto_match",
					enabled: true,
					isSystemRule: true,
					priority: 200,
					matcherFunction: "kreditrate_auto_match",
					autoApply: true,
					stopOnMatch: true,
					requiresReview: false,
